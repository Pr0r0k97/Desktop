...
def get_page_data(html, user):
    ...
    ads = soup.find('div', class_='_93444fe79c--wrapper--W0WqH').find_all('article',
    ...
    for ad in ads:
        try:
            ...
            try:
                kvdrat = ad.find('p',
                                 class_='_93444fe79c--color_gray60_100--MlpSF _93444fe79c--lineHeight_20px--tUURJ _93444fe79c--fontWeight_normal--P9Ylg _93444fe79c--fontSize_14px--TCfeJ _93444fe79c--display_block--pDAEx _93444fe79c--text--g9xAG _93444fe79c--text_letterSpacing__normal--xbqP6').text
            except:
                kvdrat = ''
